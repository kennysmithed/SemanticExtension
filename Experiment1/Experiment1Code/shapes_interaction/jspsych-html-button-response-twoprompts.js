/**
 * jspsych-html-button-response-twoprompts
 * Based on jspsych-html-button-response by Josh de Leeuw
 *
 * prompt1 is above buttons, prompt2 is below buttons
 *
 * documentation: docs.jspsych.org
 *
 **/

jsPsych.plugins["html-button-response-twoprompts"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-button-response-twoprompts',
    description: '',
    parameters: {
      stimulus: {
