  ...
  //if the received code is valid, use switch to select action based on command_code
    ...
    switch (command_code) {
      ...
      case "Matcher": //Matcher: matcher trial
        ...
        //response string
        matcher_trial(command.director_label,command.target_meaning,command.meaning_choices,command.block_n,command.trial_n,command.max_trial_n,command.partner_id)
        break;
      case "Feedback": //Feedback: feedback for director or matcher
        display_feedback(command.target,command.guess,command.score,command.break_allowed)
